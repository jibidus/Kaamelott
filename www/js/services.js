...
.factory('Sentences', function($filter) {
  ...
  var allSentences = [
		...
		{ text: '( au Père Blaise ) Pardonnez moi ? Excusez moi hein, j\'y connais rien... Euh... On a vraiment l\'impression que vous savez pas du tout ce que vous foutez là... ', character: { id: 'AppiusManilius', name: 'Appius Manilius'}, episode: {book: 'VI', number: 6, title: 'Nuptiae'}},
		{ text: '( au Maître d\'Armes ) J\'pensais à une chose, en toute amitié, un gros pain dans votre tête, ça serait de nature à vous convenir ? ', character: { id: 'AppiusManilius', name: 'Appius Manilius'}, episode: {book: 'VI', number: 6, title: 'Nuptiae'}},
		{ text: 'En fait, je m\'en suis pris deux, mais j\'ai cherché la merde. ', character: { id: 'AppiusManilius', name: 'Appius Manilius'}, episode: {book: 'VI', number: 6, title: 'Nuptiae'}},
		{ text: 'Ouais c\'est bien qu\'on reste un peu dehors, comme ça j\'pourrais vous mettre une grosse tarte en plein air. ', character: { id: 'AppiusManilius', name: 'Appius Manilius'}, episode: {book: 'VI', number: 7, title: 'Arturus Rex'}},
		{ text: 'Désolé mais vous l\'avez chié votre mariage. Ce s\'rait rien si c\'était pas juste la deuxième fois. ', character: { id: 'AppiusManilius', name: 'Appius Manilius'}, episode: {book: 'VI', number: 8, title: 'Lacrimosa'}},
		...
		{ text: 'Allez, vous devriez mettre les bouts, les demi-sels ! C\'est gentil d\'être passés ! On va vous faire un p\'tit sac avec des restes pour manger chez vous. ', character: { id: 'CrydadeTintagel', name: 'Cryda de Tintagel'}, episode: {book: 'VI', number: 8, title: 'Lacrimosa'}},
		...
		{ text: 'J\'ai dit "elle aussi" ? […] Oh, ça m\'étonne ça... Vous êtes sûr que j\'ai pas dit "elle est sympa" ?', character: { id: 'LaDameduLac', name: 'La Dame du Lac'}, episode: {book: 'III', number: 98, title: 'Hollow Man'}},
		{ text: 'Vous n’avez aucun courage. Aucune dignité. Votre manque de foi est en train de tout détruire. ', character: { id: 'LaDameduLac', name: 'La Dame du Lac'}, episode: {book: 'IV', number: 2, title: 'Tous Les Matins du Monde'}},
		{ text: '( Terrorisée ) Ils m\'ont ba... Ils m\'ont ba... (Arthur essaie divers mots) ILS M\'ONT BANNIE! ', character: { id: 'LaDameduLac', name: 'La Dame du Lac'}, episode: {book: 'IV', number: 28, title: 'La Révoquée'}},
		{ text: 'Je sais ni boire, ni manger, ni m’habiller, ni me laver, ni rien ! Vous sentez que je vais être un fardeau pour vous, ou pas ?', character: { id: 'LaDameduLac', name: 'La Dame du Lac'}, episode: {book: 'IV', number: 28, title: 'La Révoquée'}},
		{ text: 'Gardez votre épée et servez-vous en pour trouver le Graal ! [Arthur replante Excalibur]', character: { id: 'LaDameduLac', name: 'La Dame du Lac'}, episode: {book: 'V', number: 12, title: 'La roche et le fer'}},
		{ text: 'Hé ! Hééé ! J\'suis pas une spécialiste, mais, à mon avis, là, vous allez mourir, hein !', character: { id: 'LaDameduLac', name: 'La Dame du Lac'}, episode: {book: 'V', number: 36, title: 'La Nourrice'}},
		...
		{ text: '( Présentant sa nouvelle femme à Seli, Arthur et Leodagan ) Ah mais non... Mais vous vous êtes encore sur l\'ancienne ! […] Tout à fait, excusez moi j\'ai pas percuté. Non non, l\'autre elle est morte. Heu... Les articulations soutenaient plus son poids donc elle a commencé par se remplir d\'eau par les coudes et après c\'est passé aux chevilles, c\'est remonté aux genoux et un matin, elle avait tellement gonflé que j\'ai appelé la garde. Alors heu... Ils sont venus, ils lui ont mis un coup de lance et puis elle a essayé de se... de se faufiler comme ça, pour se cacher sous le buffet. Pis elle passait pas parce que bon ben... Elle avait plus conscience de sa masse donc elle est restée là, comme ça, pis... Bah six heures après, elle était crevée. Donc, la Duchesse d\'Aquitaine ! ', character: { id: 'Leducd’Aquitaine', name: 'Le duc d’Aquitaine'}, episode: {book: 'V', number: 16, title: 'Les Fruits d\'Hiver'}},
		{ text: '( Récitant d’un ton peu convaincant ) « Si c’est ma tête qui vous revient pas, vous pouvez toujours aller roupiller dans le couloir. […] Et à partir de maintenant, si j’entends un mot plus haut que l’autre je vous… renvoie dans votre bled d’at… natal à coups de pied dans… dans le fion. Comme ça vous pourrez aller ratisser la bouse et torcher le cul des poules, ça vous fera prendre l’air. » ', character: { id: 'Leducd’Aquitaine', name: 'Le duc d’Aquitaine'}, episode: {book: 'V', number: 19, title: 'Les Nocturnales'}},
		{ text: 'Non, mais on peut adapter. […] On peut dire, euh… bon, je dis : […] « Avec votre dégaine… euh… […] Avec votre dégaine de crevette, faites gaffe à pas vous faire bouffer par un mérou. » ', character: { id: 'Leducd’Aquitaine', name: 'Le duc d’Aquitaine'}, episode: {book: 'V', number: 23, title: 'Le Forfait'}},
		...
		{ text: 'Ben ils m\'ont dit d\'aller me faire mettre. Après, ils m\'ont jeté des gadins et une marmite avec un restant de soupe de poisson. ', character: { id: 'HervedeRinel', name: 'Hervé de Rinel'}, episode: {book: 'II', number: 72, title: 'L\'Alliance'}},
		{ text: 'J’ai pénétré leur lieu d\'habitation de façon subrogative […] en tapinant. ', character: { id: 'HervedeRinel', name: 'Hervé de Rinel'}, episode: {book: 'III', number: 91, title: 'L’Espion'}},
		{ text: 'Ahhh, c\'est pour ça que vous avez changé de siège, c\'est parce que vous êtes pépé... Heu non, c\'est parce que vous êtes roi. ', character: { id: 'HervedeRinel', name: 'Hervé de Rinel'}, episode: {book: 'V', number: 40, title: 'Les Pionniers'}},
		{ text: 'Y\'a plusieurs personnes qui sont passées par votre siège là, et beeen, le tout premier, je crois qu\'il s\'appelait... Carbure, ça fait vachement longtemps qu\'on l\'a pas vu. Moi, je serais vous, je lancerais des recherches. ', character: { id: 'HervedeRinel', name: 'Hervé de Rinel'}, episode: {book: 'V', number: 42, title: 'Le Destitué'}},
		{ text: 'L\'adjectif qui me correspond le mieux, c\'est : le plancton. ', character: { id: 'HervedeRinel', name: 'Hervé de Rinel'}, episode: {book: 'VI', number: 7, title: 'Arturus Rex'}},
		{ text: 'Déjà, à la base, un Burgonde, c\'est con comme une meule, alors celui-là ! Ah, vous pouvez pas savoir c\'que c\'est que de tomber interprète avec un engin pareil ! ( bruit de pet ) Tiens, vous voyez ? Toute la journée, c\'est comme ça ! Il pue, il pète, il lâche des ruines ! Tiens, l\'autre jour à table... Il devient tout bleu. Il était en train de s\'étouffer avec un os de caille, cet abruti ! Il tousse, il crache, il re-tousse, et BINGO ! Il m\'dégueule dessus ! Vous l\'croyez, ça ? ', character: { id: 'Linterpreteburgonde', name: 'L\'interprète burgonde'}, episode: {book: 'I', number: 45, title: 'L\'interprète'}},
		{ text: 'La culture burgonde ? Je savais même pas qu’y en avait une… Non, moi je voulais faire grec moderne, mais y avait plus de place. Il restait que burgonde ou anglais. Aaaaanglais ! Mais c’est encore moins répandu. ', character: { id: 'Linterpreteburgonde', name: 'L\'interprète burgonde'}, episode: {book: 'I', number: 45, title: 'L’Interprète'}},
		{ text: 'Nous, si vous réfléchissez bien, on a quatre bras. Avec les vôtres, ça fait six ! posez tout ça sur le trône, imaginez un peu les possibilités… ', character: { id: 'LesJumellesdupecheur', name: 'Les Jumelles du pêcheur'}, episode: {book: 'IV', number: 21, title: 'La Parade'}},
		{ text: 'Peau de vache.', character: { id: 'LeJurisconsulte', name: 'Le Jurisconsulte'}, episode: {book: 'V', number: 27, title: 'Le Jurisconsulte'}},
		{ text: '( Au Père Blaise ) Z\'êtes un glandeur. Un gros... GLANDEUR !!! ', character: { id: 'LeJurisconsulte', name: 'Le Jurisconsulte'}, episode: {book: 'V', number: 27, title: 'Le Jurisconsulte'}},
		{ text: 'Ah non ! AH NON ! On ne se vautre pas dans la bouffe, c\'est INTOLÉRABLE !!! Vous allez arrrrrrêter !!! ', character: { id: 'LeJurisconsulte', name: 'Le Jurisconsulte'}, episode: {book: 'V', number: 40, title: 'Les Pionniers'}},
		{ text: 'Si j\'ai envie de mettre des grosses morues dans mon plumard, JE FAIS CE QUE JE VEUX !!!', character: { id: 'LeJurisconsulte', name: 'Le Jurisconsulte'}, episode: {book: 'V', number: 41, title: 'La Conspiratrice'}},
		{ text: 'BANDES DE TROUS DU CUL !!!', character: { id: 'LeJurisconsulte', name: 'Le Jurisconsulte'}, episode: {book: 'V', number: 41, title: 'La Conspiratrice'}},
		{ text: 'Une nuit, une nuit à attendre... Une longue nuit avant de savoir si le souverain ennemi acceptera un traité de paix, si fragile, si friable, qu\'on aurait même de la peine à le prendre au sérieux. Des solutions précaires, du rafistolage, voilà tout ce que j\'ai su inventer. La Bretagne résistait quand je suis arrivé, elle résistera encore quand je partirai. Je ne saurais dire pourquoi, je conserve encore, rescapée de mon découragement, une curiosité : existe t-il quelqu\'un parmi nous déjà - ou encore à naitre - qui se destine à restaurer l\'ordre sur l\'île de Bretagne? Et si il existe, que peut-il bien posséder que je ne possède moi-même ? D\'où vient-il? Est-il romain? Quel arme tient-il à sa ceinture ? Celui qui vaincra là où j\'ai échoué, je voudrais voir son visage une fois, car je lui conserve encore un rescapé de mon découragement : ma curiosité. ', character: { id: 'ManiusMacrinusFirmus', name: 'Manius Macrinus Firmus'}, episode: {book: 'VI', number: 1, title: 'Miles Ignotus'}},
		{ text: 'C\'est tout ? Treize ans qu\'ils me laissent pourrir sur pied, dans ce pays de merde ! Treize ans ! Maintenant ils m\'envoient un message, il faut que je rentre chez moi ! [...] Mais qu\'est ce qui leur fait croire que ça existe encore chez moi ?!! Est-ce qu\'un type qui a foutu le camp treize ans peut encore avoir un chez soi ? C\'est complètement absurde... ', character: { id: 'ManiusMacrinusFirmus', name: 'Manius Macrinus Firmus'}, episode: {book: 'VI', number: 6, title: 'Nuptiæ'}},
		...
		{ text: 'Ca y est ! C’est leur dernière saison aux débiles. Tu peux préparer les outils, on passe directement de la discussion à la désintégration. ', character: { id: 'LuciusSilliusSallustius', name: 'Lucius Sillius Sallustius'}, episode: {book: 'VI', number: 4, title: 'Arturi inquisitio'}},
		{ text: '( Capito : Les quatre en une seule fois, vous avez pas peur que ça soit un peu voyant non ? ) Rien à foutre ! Tu peux même les crucifier sur une estrade au milieu du forum si ça te chante, c’est moi qui paye l’orchestre. ', character: { id: 'LuciusSilliusSallustius', name: 'Lucius Sillius Sallustius'}, episode: {book: 'VI', number: 4, title: 'Arturi inquisitio'}},
		{ text: 'Je vais poser une question simple : et vous, vous le méritez ? Ah non mais attendez, est-ce que vous le méritez, est-ce que vous méritez votre place ?! Urgo ! Tu devais aller en Germanie... c\'est ta tante qui t\'a fait entrer au sénat ! Pisansius ! Pas une seule année dans la légion, pas une seule ! J\'m...e demande même parfois si t\'as déjà tenu une arme dans ta vie... Destisius ! C\'est ton père qui a donné la moitié de ses terres pour que quelqu\'un puisse prendre ta place en Afrique... C\'est vrai ou c\'est pas vrai ? Vous êtes tous des planqués, tous, tous, tous, tous , tous. ', character: { id: 'LuciusSilliusSallustius', name: 'Lucius Sillius Sallustius'}, episode: {book: 'VI', number: 5, title: 'Dux Bellorum'}},
		{ text: 'Dans votre position, il y a plus de chance de subir un siège que d\'en organiser un !', character: { id: 'SefrianedAquitaine', name: 'Séfriane d\'Aquitaine'}, episode: {book: 'III', number: 16, title: 'Séfriane d\'Aquitaine'}},
		{ text: 'Je suis assez grande pour voir que si vous achetez des troncs d\'arbres à ce prix-là, vous êtes en train de vous faire enfler !', character: { id: 'SefrianedAquitaine', name: 'Séfriane d\'Aquitaine'}, episode: {book: 'III', number: 16, title: 'Séfriane d\'Aquitaine'}},
		{ text: 'Vous croyez quoi ? Que ça s\'trouve dans l\'cul des poules, le fric ?', character: { id: 'SefrianedAquitaine', name: 'Séfriane d\'Aquitaine'}, episode: {book: 'III', number: 16, title: 'Séfriane d\'Aquitaine'}},
		{ text: 'Quand je vais raconter à mon oncle combien vous raquez pour vos béliers pourris, il va bien se marrer !', character: { id: 'SefrianedAquitaine', name: 'Séfriane d\'Aquitaine'}, episode: {book: 'III', number: 16, title: 'Séfriane d\'Aquitaine'}},
		{ text: 'Quoi ? Qu\'est-ce qu\'y a ? On cherche la marave ?', character: { id: 'SefrianedAquitaine', name: 'Séfriane d\'Aquitaine'}, episode: {book: 'III', number: 16, title: 'Séfriane d\'Aquitaine'}},
		{ text: 'Oh allez mon pote ! Fais un effort ! Dans dix minutes t\'es pendu et on n\'en parle plus. ', character: { id: 'SpuriusCordiusFrontinius', name: 'Spurius Cordius Frontinius'}, episode: {book: 'VI', number: 5, title: 'Dux Bellorum'}},
		{ text: 'D\'autant que les orchestres en Bretagne franchement, autant se frotter les noyaux avec des orties! ', character: { id: 'SpuriusCordiusFrontinius', name: 'Spurius Cordius Frontinius'}, episode: {book: 'VI', number: 8, title: 'Lacrimosa'}},
		{ text: 'Oui ... et tu veux les jeter où tes épluchures ? ... en Germanie ? Balance-moi tes saloperies, et radine sur le champs. PARCE-QUE QUAND je dis TOUT l\'MONDE ... ET BEN C\'EST TOUT L\'MONDE ! ... Tu es gentil.', character: { id: 'SpuriusCordiusFrontinius', name: 'Spurius Cordius Frontinius'}, episode: {book: 'VI', number: 8, title: 'Lacrimosa'}},
...
.factory('Characters', function() {
	...
	var allCharacters = [ 
		...
		{id: 'HervedeRinel', name: 'Hervé de Rinel'},
		{id: 'Dagonet', name: 'Dagonet'},
		{id: 'CrydadeTintagel', name: 'Cryda de Tintagel'},
		{id: 'Leducd’Aquitaine', name: 'Le duc d’Aquitaine'},
		{id: 'Meleagant', name: 'Méléagant'},
		{id: 'Grudu', name: 'Grüdü'},
		...
		{id: 'Leodagan', name: 'Léodagan'},
		{id: 'Lemaitred’armes', name: 'Le maître d’armes'},
		{id: 'Mevanwi', name: 'Mevanwi'},
		{id: 'Ygerne', name: 'Ygerne'},
		{id: 'LesJumellesdupecheur', name: 'Les Jumelles du pêcheur'},
		{id: 'AppiusManilius', name: 'Appius Manilius'},
		{id: 'Linterpreteburgonde', name: 'L\'interprète burgonde'},
		{id: 'Anna', name: 'Anna'},
		{id: 'LeRepurgateur', name: 'Le Répurgateur'},
		{id: 'Guenievre', name: 'Guenièvre'},
		{id: 'Karadoc', name: 'Karadoc'},
		{id: 'EliasdeKelliwic’h', name: 'Élias de Kelliwic’h'},
		{id: 'Angharad', name: 'Angharad'},
		{id: 'Edern', name: 'Edern'},
		{id: 'Leroiburgonde', name: 'Le roi burgonde'},
		{id: 'LuciusSilliusSallustius', name: 'Lucius Sillius Sallustius'},
